...
```console
$ kubectl apply -f https://github.com/kubedb/docs/raw/del-dorm/docs/examples/mongodb/custom-rbac/mg-custom-role.yaml
...
```console
$ kubectl apply -f https://github.com/kubedb/docs/raw/del-dorm/docs/examples/mongodb/custom-rbac/mg-custom-db.yaml
...
```console
$ kubectl apply -f https://github.com/kubedb/docs/raw/del-dorm/docs/examples/mongodb/custom-rbac/mg-custom-db-two.yaml
mongodb.kubedb.com/quick-mongodb created
```
